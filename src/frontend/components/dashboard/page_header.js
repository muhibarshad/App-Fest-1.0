  ...
  return (
    ...
    >
      <Toolbar sx={{height: '10vh', color: 'white'}}>
        <Typography variant="h5" sx={{flexGrow: 1}} className={style.heading
         && style.color}>
          {title}
        </Typography>
        {is_search &&
        ...
        <Icon_button sx={{color: '#C5C7CD',
          mr: is_small_screen ? -1 : 3}} onClick={search_handler}>
          <Search_icon />
        </Icon_button>
